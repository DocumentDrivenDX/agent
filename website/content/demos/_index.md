...
Terminal recordings showing DDX Agent in action with [LM Studio](https://lmstudio.ai/) and `qwen3-coder-next`.

## Read a file and explain it

Model reads `main.go` using the read tool and describes the program.

<script src="https://asciinema.org/a/demo.js" id="asciicast-read" async data-src="/agent/demos/file-read.cast" data-cols="100" data-rows="30"></script>
<noscript>
...
<script src="https://asciinema.org/a/demo.js" id="asciicast-edit" async data-src="/agent/demos/file-edit.cast" data-cols="100" data-rows="30"></script>
<noscript>
...
<script src="https://asciinema.org/a/demo.js" id="asciicast-bash" async data-src="/agent/demos/bash-explore.cast" data-cols="100" data-rows="30"></script>
<noscript>
